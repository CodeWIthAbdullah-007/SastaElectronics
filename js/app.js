...
function renderHeader(activePage) {
    ...
    <div class="header-inner">
      ...
      <div class="header-actions">
        ...
        <a href="login.html" class="header-action-btn" title="Account">${ICONS.user}</a>
  ...
  <div class="mobile-nav" id="mobileNav">${navHtml}<a href="wishlist.html">Wishlist</a><a href="cart.html">Cart</a><a href="login.html">My Account</a></div>`;
}
